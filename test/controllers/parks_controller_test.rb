...
class ParksControllerTest < ActionController::TestCase
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post :create, park: { hasWashroom: @park.hasWashroom, lat: @park.lat, lon: @park.lon, name: @park.name }
    end
  ...
  test "should update park" do
    patch :update, id: @park, park: { hasWashroom: @park.hasWashroom, lat: @park.lat, lon: @park.lon, name: @park.name }
    assert_redirected_to park_path(assigns(:park))
  end
